...
function cargarImagenes() {
    let innerHtml = '';
    imagen.src = objImageById[imagenPosicion];
    objImageById.slice(imagenPosicion - 1 <= 0 ? 0 : imagenPosicion - 1, imagenPosicion == 0 ? imagenPosicion + 3 : imagenPosicion + 1).forEach(img => {
        innerHtml += `<image src="${img}" class="m-3">`;
    });
